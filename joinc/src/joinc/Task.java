...
public class Task {
    ...
    /**
     * Contains all VM command line parameters that need to be passed when the task 
     * is started.
     */         
    public final String [] vmParameters;
    ...
    public Task(String className, String stdoutFile, String stderrFile,
		String stdinFile, String[] parameters, String[] vmParameters,
